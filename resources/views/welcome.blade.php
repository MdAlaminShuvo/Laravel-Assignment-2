...
<html lang="en">
  <head>
    ...
    <link
    href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,400;0,600;1,500&display=swap"
    rel="stylesheet"
    />

    @vite(['resources/css/index.css', 'resources/css/query.css', 'resources/js/app.js', 'resources/js/index.js'])
      ...
      <div class="main_container">
        ...
        <div class="right_section">
          <div class="informations">
            <div class="class_info"><p>Class per week</p>
            <p>3</p></div>
